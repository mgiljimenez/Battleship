...
barco_icon = {1: "🚣", 2: "🚢", 3: "🛳️", 4: "🚤"}  #Iconos de los tipos de barcos
agua_icon= "🌊" #Icono que se muestra cuando se dispara en agua
shoot_icon="💥" #Icono que se muestra cuando se dispara en un barco
instrucciones="""
